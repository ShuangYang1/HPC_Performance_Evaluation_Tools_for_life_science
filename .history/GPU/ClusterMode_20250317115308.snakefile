...
sponge_singlenode_score=config.get("sponge_singlenode_score",False)
gromacs_singlenode_score=config.get("gromacs_singlenode_score",False)
amber_singlenode_score=config.get("amber_singlenode_score",False)
dsdp_singlenode_score=config.get("dsdp_singlenode_score",False)

singlenode_scores={}
singlenode_scores["SPONGE"]=sponge_singlenode_score
singlenode_scores["GROMACS"]=gromacs_singlenode_score
singlenode_scores["AMBER"]=amber_singlenode_score
singlenode_scores["DSDP"]=dsdp_singlenode_score
