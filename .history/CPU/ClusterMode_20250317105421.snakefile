...
bwa_singlenode_score=config.get("bwa_singlenode_score",False)
spades_singlenode_score=config.get("spades_singlenode_score",False)
bismark_singlenode_score=config.get("bismark_singlenode_score",False)
star_singlenode_score=config.get("star_singlenode_score",False)
cellranger_singlenode_score=config.get("cellranger_singlenode_score",False)
gatk_singlenode_score=config.get("gatk_singlenode_score",False)

singlenode_scores={}
singlenode_scores["BWA"]=bwa_singlenode_score
singlenode_scores["SPAdes"]=spades_singlenode_score
singlenode_scores["Bismark"]=bismark_singlenode_score
singlenode_scores["STAR"]=star_singlenode_score
singlenode_scores["Cellranger"]=cellranger_singlenode_score
singlenode_scores["GATK"]=gatk_singlenode_score
