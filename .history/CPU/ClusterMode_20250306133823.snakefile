...
delete=config.get("delete-intermediate-filess",False)
...
rule all:
    ...
    run:
        generate_report(multitasks_count,partition,nodelist,cpus,cpus_per_task_dic,node_exporter_port,server_ip,server_port)
